    ...
    <div class="app-container" v-loading="loading">
        <div class="container">
            <div class="handle-box">
                <el-row :gutter="20">
                    <el-button type="primary" @click="handleAddPaymentMethod" size="small">添加保证金收款银行卡</el-button>
                    <!--
            ...
            <el-table :data="payment_method_list" style="width: 100%;margin-top:30px;" border fixed>
                <el-table-column align="center" label="ID" type="index"></el-table-column>
                ...
                <el-table-column align="header-center" label="收款统计"></el-table-column>
...
import { getAllMethod,putIsOpen,putAvailable,getCreate,addMethod } from '@/api/user_pledge'

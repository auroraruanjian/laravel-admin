    ...
    <div class="app-container" v-loading="loading">
        ...
        <div class="container" style="margin-top:20px;">
            <el-table :data="deposit_list" style="width: 100%;" border >
                ...
                <el-table-column align="center" label="Operations">
                    <template slot-scope="scope">
                        <el-button type="primary" size="small" v-permission="'user_self_deposits/detail'" v-if="scope.row.status==2||scope.row.status==3" @click="handleView(scope,1)">详情</el-button>
                        <el-button type="danger" size="small" v-permission="'user_self_deposits/verify'" v-else-if="scope.row.status==1" @click="handleView(scope,2)">确认充值</el-button>
                        <el-button type="warning" size="small" v-permission="'user_self_deposits/deal'" v-else @click="handleView(scope,3)">人工审核</el-button>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <el-dialog :visible.sync="dialogVisible" :title="dialogType!=='deal'?'订单明细':'人工处理'">
            <el-form  label-position="right" label-width="140px" >
                <el-row>
                    <el-col :span="12"><el-form-item label="用户名：">{{deposit.username}}</el-form-item></el-col>
...
<script>
    ...
    import { getDeposits,getDetail,putDeal,putVerify } from '@/api/user_self_deposits'
